    ...
    <div class="container mx-auto">
        <div class="flex flex-wrap justify-center">
            <div class="w-full max-w-sm">
                ...
                <form id="create_label" method="POST" action="{{ action('CollectionController@saveLabel', ['collection' => $collection, 'artifact' => $artifact]) }}">
                ...
                {{ csrf_field() }}
                    ...
                    <div class="mb-2">
                        ...
                        <label for="position" class="w-full md:mb-0 font-semibold text-gray-600 text-sm pt-2 pr-3 align-middle">Artist</label>
