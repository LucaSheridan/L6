...
<div class="flex flex-wrap">                    
    ...
    <div class="w-full sm:w-1/3 md:w-1/4 bg-gray-500 p-4">
        ...
        {{-- Begin Assignment Select for Mobile --}}
                   ...
                   <!--  <div class="hidden sm:block bg-gray-200 p-1 rounded-lg">
                     

                        @foreach ($currentSection->assignments as $assignment)

                        <div class="bg-gray-200 p-1 text-sm ml-1 text-gray-700">
           ...
           <!--  <div class="bg-gray-200 border-red-400 border-2 rounded-lg p-2 text-gray-600">Want to Join a Class?</div> </div>  -->                     



    </div>

    <div class="w-full sm:w-2/3 md:w-3/4 bg-red-300 p-4 pt-2">
