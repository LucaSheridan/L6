            ...
            {{-- Begin Assignment Content for Mobile --}}
                ...
                <div class="flex bg-gray-100  border-0">
                    ...
                    <select class="w-full px-2 py-1 pr-8 m-0 bg-gray-300 text-sm font-semibold text-gray-600 form-select" onchange="location = this.value;">
                          ...
                          <!--  <option class="" value="{{action('AssignmentController@show', ['assignment' => $activeAssignment->id , 'section' => $activeSection->id])}}">{{$activeAssignment->title}}</option>
 -->
                           <option class="" value="{{action('AssignmentController@gallery', ['section' => $activeSection , 'assignment' => $activeAssignment ])}}" class="p-0 m-0 hover:text-red-400 hover:rounded no-underline text-sm">
                           {{ $activeAssignment->title}}</option>
                             ...
                             @if ( $activeAssignment->id == $assignment->id ) 
                                    ...
                                    @else
                                          <option class="" value="{{action('AssignmentController@gallery', ['section' => $activeSection->id , 'assignment' => $assignment->id ])}}" class="p-0 m-0 hover:text-red-400 hover:rounded no-underline text-sm">
                        ...
                        @if ($activeAssignment->components->count() < 2)
                                ...
                                <div class="block body text-gray-600 text-sm mt-0 mb-0">
                                    ...
                                    <div class="p-1 ">
                                        ...
                                        <a href="{{action('ComponentController@gallery', ['section' => $assignment->section_id , 'assignment' => $component->assignment_id , 'component' => $component->id ])}}" class="p-0 m-0 hover:text-red-400 hover:rounded no-underline text-lg">
                                       
                                        @if ($loop->first)

                                        <span class="text-red-500 bg-gray-300">{{ $component->title}}</span>
                        ...
                        @else
                            ...
                            {{-- Multi Component --}}
                                    ...
                                    <div class="p-1">
                                        ...
                                        <a href="{{action('ComponentController@gallery', ['section' => $assignment->section_id , 'assignment' => $component->assignment_id , 'component' => $component->id ])}}" class="p-0 m-0 hover:text-red-400 hover:rounded no-underline text-md font-semibo">
                                 
                                        @if ($loop->first)

                                        <span class="text-red-500">{{ $component->title}}</span>
