    ...
    <div class="container mx-auto">
        <div class="flex flex-wrap justify-center">
            <div class="w-full min-w-md max-w-lg">
                ...
                <p class="mx-2 mt-8 text-center">Are you sure you want to delete <i>{{$component->title}}</i>?</p>
                ...
                <input type="hidden" name="_method" value="DELETE">
                    ...
                    <div class="my-8 text-center">
                          ...
                          <a href="{{action('AssignmentController@show', ['section' => $section, 'assignment' => $assignment])}}"

                        class="inline-block mb-1 md:mb-0 bg-gray-400 hover:bg-gray-500 text-gray-700 hover:text-white px-4 py-2 text-sm uppercase tracking-wide font-semibold rounded">No</a>
