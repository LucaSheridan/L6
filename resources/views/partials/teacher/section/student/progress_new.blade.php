...
{{-- START STUDENTS ----------------------------------------------------------------}}
 ...
 <div class="w-full  sm:w-1/3 md:w-1/4 b-4 sm:mb-0 sm:border-r-8 border-gray-500">
    ...
    <div class="p-2 bg-gray-400 w-full rounded-lg ">
            ...
            {{-- Look for unset/not matching current assignent variable --}}
               ...
               {{-- Assignment Header--}}
                    ...
                    <div class="flex flex-col">
                        <div class="border-2">
                            <div class="text-red-600 text-md font-semibold text-gray-400 p-1">
                ...
                <div class="w-32 py-2 pl-1"></div
                <div class="w-auto text-xs text-gray-500 font-semibold  p-2 ">Component</div>
    ...
    <td valign="center">
            ...
            {{-- Display Preview Image  --}}
                ...
                @if (!$checklistItem->artifact_created)
                     ...
                     <div class="flex block items-center bg-red-300 border-gray-600 border-2 rounded-lg">
                     <div class="flex inline-block w-16 h-16 text-center text-sm ">pending
                        </div>
                    </div>
                    @else
